    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm">
        ...
        <p className="text-gray-600 leading-relaxed">
          {isLoggedIn
            ? "Choitame（ちょいため）へようこそ！ここではあなたの依頼や報告を管理できます。まずは新しい依頼を作成するか、既存の依頼を確認してみましょう。"
            : "Choitameは、小さな依頼と報告を通じてコミュニティを活性化させるプラットフォームです。ログインすると、依頼の作成や報告の投稿、コメントなどの全ての機能を利用できるようになります。"}
        </p>
        {!isLoggedIn && (
          <div className="mt-6">
            <Link
